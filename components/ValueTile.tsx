...
const VALUE_ICONS: Record<string, { svg: React.ReactNode; color: string }> = {
  "💡": {
    color: "#a094e8",
    svg: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#a094e8" strokeWidth="1.5" strokeLinecap="round">
  ...
  "⭐": {
    color: "#0fb8a0",
    svg: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#0fb8a0" strokeWidth="1.5" strokeLinecap="round">
...
export default function ValueTile({ title, description, icon }: ValueTileProps) {
  ...
  return (
    <div className="glass-card glass-card-hover rounded-2xl p-6 flex gap-5 items-start">
      ...
      <div>
        <h3 className="text-base font-bold mb-2" style={{ fontFamily: "var(--font-syne)", color: "#f0f2f8" }}>{title}</h3>
